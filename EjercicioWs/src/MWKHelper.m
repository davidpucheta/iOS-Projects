...
{
    DDXMLNode* child=[MWKHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[MWKHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[MWKHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
